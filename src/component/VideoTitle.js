const VideoTitle=({title,overview})=>{
    return (
        <div className=" w-screen aspect-video px-4 md:px-16 pt-[20%] absolute text-white bg-gradient-to-r from-black">
         <h1 className=" text-2xl md:text-5xl font-bold p-4">{title}</h1>
         <p className="hidden md:inline-block text-lg p-4 w-1/2">{overview}</p>
